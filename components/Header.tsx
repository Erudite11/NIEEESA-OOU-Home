    ...
    <header className="bg-blue-50 shadow-sm">
      <div className="max-w-6xl mx-auto px-2 py-2 flex items-center justify-between ">
        <div className="flex items-center gap-3">
          ...
          <Image src="/uploads/oou.jpg" alt="" width={40} height={40} />
          <Image src="/uploads/nieesa.jpg" alt="" width={40} height={40} /> 
        ...
        <nav className="flex items-center gap-6">
          ...
          <Link href="#level" className="text-sm text-gray-700 hover:text-gray-900">
           <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
